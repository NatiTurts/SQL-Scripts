Declare @StartDate@ date = '2019-01-06'
Declare @EndDate@ date = '2019-09-30'
...
, Month_Sales as [Month]
from #Temp

group by ItemStyleCode, Month_Sales) as T1
...
, [Pot ave mnt Stock 2018 Ave] = ISNULL(Round(NULLIF((SUM(S.Qty_On_Hand)+SUM(S.QtyOnPO))/NULLIF((T1.[Sales 2019]/CAST(MONTH(@EndDate@) as INT)),0),0),2),0)
