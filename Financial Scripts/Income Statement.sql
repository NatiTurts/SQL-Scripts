...
, AccountType_Old = [dbo]._efnLedgerAccountTypeDescription(F.iAccountType)	COLLATE Latin1_General_CI_AS 
...
and ( ((T.txdate >= '2018-01-01')  and (T.Txdate <= '2018-05-31'))) and T.AutoIdx  not in  (94214,
94229,
94218,
94225,
94228,
...
where  F.AccountTypeDescription in ('Other Income','Revenue')
and ( ((X.txdate >= '2018-06-01')  and (X.Txdate <= '2018-12-31'))) and x.autoIdx  not in  (94214,
94229,
94218,
94225,
94228,
